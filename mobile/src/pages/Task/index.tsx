            ...
            <Row style={{marginTop: 10, justifyContent:"space-between"}}>
                ...
                <Description>
                    <BodyLight color={themes.colors.lightGrey}>
                        Ad eu nisi minim non nisi enim nostrud incididunt ad proident consectetur exercitation eiusmod. Ex sunt nisi officia esse. Nisi officia et irure in deserunt qui aliquip voluptate. Consequat pariatur dolor ut quis enim consectetur cillum velit ut est tempor sit.Ad eu nisi minim non nisi enim nostrud incididunt ad proident consectetur exercitation eiusmod. Ex sunt nisi officia esse. Nisi officia et irure in deserunt qui aliquip voluptate. Consequat pariatur dolor ut quis enim consectetur cillum velit ut est tempor sit.
                    </BodyLight>
                </Description>
                <ContactSection>
                    ...
                    <Button style={{backgroundColor: themes.colors.green, 
                                    borderColor: themes.colors.green, 
                                    marginTop: 20}}>
                        Ir para WhatsApp
                    </Button>
                    <Button style={{marginTop:20, marginBottom: 40}}>Ligar no telefone</Button>
                </ContactSection>
        </StyledScrollView>
    );
}
