...
const OtherUsersProfile: React.FC = () =>{
    return(
        <Container>
            <NavigationHeader isEdit={false}>Perfil</NavigationHeader>
            <PicNameNBio>
                <StyledImage source={{uri:"https://avatars.githubusercontent.com/u/43298753?v=4"}}/>
                <TitleHeavy style={{marginTop: 30, marginBottom: 6}}>Guilherme Guatura</TitleHeavy>
